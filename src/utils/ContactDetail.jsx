...
const ContactDetail = ({logo, heading, title, link}) => {
  return (
      ...
      <div>
          ...
          <div className='flex flex-row max-w-[336px] gap-3.5 cursor-pointer p-6 transition-all duration-300 ease-in-out rounded-lg bg-white hover:shadow-lg'>
              <a href={link} className='logo w-[18%] text-2xl bg-primary-400 text-white flex justify-center items-center transition-all duration-300'> {logo} </a>
